...
pub mod message_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_private_room_id(
            &mut self,
            request: impl tonic::IntoRequest<super::GetPrivateRoomIdRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetPrivateRoomIdResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("message.MessageService", "GetPrivateRoomId"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn stream_live_messages(
            ...
            tonic::Response<tonic::codec::Streaming<super::MessageItem>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("message.MessageService", "StreamLiveMessages"));
...
pub mod message_service_server {
    ...
    pub trait MessageService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_private_room_id(
            &self,
            request: tonic::Request<super::GetPrivateRoomIdRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetPrivateRoomIdResponse>,
            tonic::Status,
        >;
        ...
        type StreamLiveMessagesStream: tonic::codegen::tokio_stream::Stream<
            ...
            + std::marker::Send
            + 'static;
        async fn stream_live_messages(
            &self,
            request: tonic::Request<super::StreamRequest>,
        ) -> std::result::Result<
            tonic::Response<Self::StreamLiveMessagesStream>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/message.MessageService/GetChannelHistory" => {
                    ...
                    struct GetChannelHistorySvc<T: MessageService>(pub Arc<T>);
                    impl<
                        T: MessageService,
                    > tonic::server::UnaryService<super::HistoryRequest>
                    for GetChannelHistorySvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as MessageService>::get_channel_history(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let fut = async move {
                        let method = GetChannelHistorySvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                ...
                "/message.MessageService/GetPrivateRoomId" => {
                    #[allow(non_camel_case_types)]
                    struct GetPrivateRoomIdSvc<T: MessageService>(pub Arc<T>);
                    impl<
                        T: MessageService,
                    > tonic::server::UnaryService<super::GetPrivateRoomIdRequest>
                    for GetPrivateRoomIdSvc<T> {
                        type Response = super::GetPrivateRoomIdResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MessageService>::get_private_room_id(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetPrivateRoomIdSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/message.MessageService/StreamLiveMessages" => {
                    ...
                    for StreamLiveMessagesSvc<T> {
                        type Response = super::MessageItem;
                        type ResponseStream = T::StreamLiveMessagesStream;
                        type Future = BoxFuture<
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MessageService>::stream_live_messages(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = StreamLiveMessagesSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "message.MessageService";
